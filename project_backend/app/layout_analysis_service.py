...
AUTO_ROI_PARAGRAPH_MAX_GAP_HEIGHT_RATIO = float(os.getenv("AUTO_ROI_PARAGRAPH_MAX_GAP_HEIGHT_RATIO", "2.2"))
AUTO_ROI_PARAGRAPH_MIN_X_OVERLAP_RATIO = float(os.getenv("AUTO_ROI_PARAGRAPH_MIN_X_OVERLAP_RATIO", "0.40"))
